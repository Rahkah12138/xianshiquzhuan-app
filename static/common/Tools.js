//Update: 邓志锋 <2790138611@qq.com> <http://https://konjianzhi.cn/>
...
class Tools {
	...
	renderImage(path) {
		...
		if (path.indexOf('https://konjianzhi.cn//upload') > 0) {
			path = path.replace('https://konjianzhi.cn/', 'lib.diygw.com');
		}
		return path;
	}
